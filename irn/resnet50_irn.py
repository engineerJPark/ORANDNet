...
class Net(nn.Module):
    ...
    def forward(self, x):
        ...
        # print("x1 sizes : ", x1.shape)
        # print("x2 sizes : ", x2.shape)
        # print("x3 sizes : ", x3.shape)
        # print("x4 sizes : ", x4.shape)
        # print("x5 sizes : ", x5.shape) # these result is 128 128
        ...
        # print("edge1 sizes : ", edge1.shape)
        # print("edge2 sizes : ", edge2.shape)
        # print("edge3 sizes : ", edge3.shape)
        # print("edge4 sizes : ", edge4.shape)
        # print("edge5 sizes : ", edge5.shape)
        # print("edge_out sizes : ", edge_out.shape)
        ...
        # print("dp1 sizes : ", dp1.shape)
        # print("dp2 sizes : ", dp2.shape)
        # print("dp3 sizes : ", dp3.shape)
        # print("dp4 sizes : ", dp4.shape)
        # print("dp5 sizes : ", dp5.shape)
        # print("dp_up3 sizes : ", dp_up3.shape)
        # print("dp_out sizes : ", dp_out.shape)
...
class EdgeDisplacement(Net):
    ...
    def forward(self, x, coco=False):
        ...
        # print("feat_size : ", feat_size) # : (3, 120, 160)
        # print("input x : ", x.shape)
        if not coco:
            x = F.pad(x, [0, self.crop_size-x.size(3), 0, self.crop_size-x.size(2)])
        edge_out, dp_out = super().forward(x) # this make error as [2, 1, 120, 128], not (3, 120, 160)
